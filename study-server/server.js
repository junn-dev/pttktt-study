...
const topics = [
  ...
  { id: "robot", group: "BFS - DFS", name: "Rôbot", visual: "stateGraph", fields: [{ name: "x", label: "x", value: "4" }, { name: "y", label: "y", value: "3" }] },
  ...
  { id: "queen", group: "Quay lui", name: "Quân hậu", visual: "board", fields: [{ name: "n", label: "n", value: "4" }] },
  ...
  { id: "dance", group: "Tham lam", name: "Khiêu vũ", visual: "matching", fields: [{ name: "a", label: "Dãy A", value: "180 170 160" }, { name: "b", label: "Dãy B", value: "175 165 150" }] },
  ...
  { id: "metal", group: "Tham lam", name: "Nối thanh kim loại", visual: "heapSteps", fields: [{ name: "values", label: "Độ dài thanh", value: "4 3 2 6" }] },
